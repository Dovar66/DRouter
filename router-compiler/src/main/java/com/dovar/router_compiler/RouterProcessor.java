...
public class RouterProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        if (annotations.isEmpty()) {
            ...
            TypeSpec.Builder mBuilder = TypeSpec.classBuilder(RouterStr.ProxyClassSimpleName + "$$" + moduleName)
            ...
            generateModuleInitMap(mBuilder, moduleList);
    ...
    private void generateServiceMap(TypeSpec.Builder mBuilder, Set<? extends Element> serviceLoaders) {
        ...
        mBuilder.addMethod(initBuilder.build()).build();
    }
...
//        ClassName application = ClassName.get("android.app", "Application");
        ...
        MethodSpec.Builder initBuilder = MethodSpec.methodBuilder("createUIRouterMap")
                .addModifiers(Modifier.PUBLIC)
...
//        initBuilder.endControlFlow();
        ...
        mBuilder.addMethod(initBuilder.build());
    }

    private void generateModuleInitMap(TypeSpec.Builder mBuilder, Set<? extends Element> modules) {
...
//                .addParameter(String.class, "processName");
        ...
        mBuilder.addMethod(registerModule)
